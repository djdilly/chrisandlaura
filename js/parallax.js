$('.parallax').scroll(function() {
    ...
    var heightOfImage3 = $('.blackOverlay3').height()
    var quarterHeightOfImage3 = heightOfImage3 / 4
    var dimPoint3 = ($('.blackOverlay3').offset().top - $('.blackOverlay3').parent().position().top) + quarterHeightOfImage3;
    if (dimPoint3 < 0 && dimPoint3 + heightOfImage3 > 0) {
        $(".blackOverlay3").css("opacity", 0 - dimPoint3 / 700);
    }
});